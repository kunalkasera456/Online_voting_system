...
<link rel="stylesheet" type="text/css" href="style.css"> 
 <%
    ...
    String a[] = new String[100];
 	...
 	java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/onlinevotingdb2","root","KUNAL#456kasera");
...
<tr>
<td>
<img src="images/bjp.webp" alt="BJP">
</td>
<td>BJP</td>
<td><%=a[1]%></td>
</tr>
